...
class XMLString {
    ...
    searchForParticalMatch(searchTerm, searchingStr){
        ...
        // var found = searchingStr.search(reg);
        // console.log('foundArrayIndexes', foundArrayIndexes); 
    ...
    foundArray = []; foundArrayIndexes=[];
    searchTagsInXMLString(searchTerm){
        //searching through ALL items of XMLString


        // this.singleXMLString.forEach((item,index)=>{
        //     this.foundArray.push(item);
        // });
        
        // console.log('foundArray', this.foundArray); 
...
class XMLString {
    ...
    //================================
    returnArrayFromRange=[];
    searchRange(rangeArray){
        this.bigJoin(); this.bigSplit();
        for(var i=0; i<rangeArray.length; i++){
            this.returnArrayFromRange.push(this.singleXMLString[rangeArray[i]]);
        }
        return this.returnArrayFromRange;
    }
